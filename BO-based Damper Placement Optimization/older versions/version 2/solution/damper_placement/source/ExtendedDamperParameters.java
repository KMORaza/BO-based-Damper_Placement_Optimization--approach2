...
public class ExtendedDamperParameters {
    ...
    private double[] computeMotionRatios() {
        ...
        for (int i = 0; i < 4; i++) {
            ...
            // Add minimum denominator to prevent division by near-zero
            double denominator = Math.max(effectiveLength * angleFactor + 0.1, 0.2);
            ratios[i] = clamp(1.0 / denominator, 0.5, 2.0); // Clamp ratios
        }
        return ratios;
    }

    // Getters (unchanged)
    public double getFrontCompressionDamping() { return frontCompressionDamping; }
    public double getFrontReboundDamping() { return frontReboundDamping; }
    public double getRearCompressionDamping() { return rearCompressionDamping; }
    public double getRearReboundDamping() { return rearReboundDamping; }
    public double getBlowOffThreshold() { return blowOffThreshold; }
    public double getGasPressure() { return gasPressure; }
    public double getFrontMountingX() { return frontMountingX; }
    public double getFrontMountingY() { return frontMountingY; }
    public double getFrontMountingZ() { return frontMountingZ; }
    public double getRearMountingX() { return rearMountingX; }
    public double getRearMountingY() { return rearMountingY; }
    public double getRearMountingZ() { return rearMountingZ; }
    public double getFrontInclinationAngle() { return frontInclinationAngle; }
    public double getRearInclinationAngle() { return rearInclinationAngle; }
    public double getFrontSpringStiffness() { return frontSpringStiffness; }
    public double getRearSpringStiffness() { return rearSpringStiffness; }
    public double getCamberAngle() { return camberAngle; }
    public double getAntiDiveRatio() { return antiDiveRatio; }
    public String getDampingProfile() { return dampingProfile; }
    public double[] getMotionRatios() { return motionRatios.clone(); }
}